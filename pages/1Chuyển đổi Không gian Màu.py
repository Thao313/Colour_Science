...
Chon_khong_gian_mau = st.sidebar.radio("Chuyển không gian màu", ("sRGB to XYZ", "XYZ to sRGB", "XYZ to Lab"))
#sidebar: để ở tay trái
col1,col2 = st.columns(2) #chia màn hình thành 2 cột
